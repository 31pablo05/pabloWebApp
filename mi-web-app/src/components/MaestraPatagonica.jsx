...
const MaestraPatagonica = () => {
  ...
  const progressStatus =
    project.progress === 100 ? 'Finalizado' : 'En producción';
  ...
  return (
    ...
    >
      <div className="relative h-48 sm:h-56 md:h-64">
        <motion.img
          src="/assets/images webp/maestrapatcaptura.webp"
          alt="Vista previa de Maestra Patagónica"
        ...
        <motion.video
          ...
          loop
          muted
          aria-label="Video demo de Maestra Patagónica"
          title="Video demo de Maestra Patagónica"
...
export default MaestraPatagonica;
