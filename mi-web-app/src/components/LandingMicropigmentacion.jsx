...
const LandingMicropigmentacion = () => {
  const [loaded, setLoaded] = useState(false);

  const project = {
    name: 'Landing Page - Curso de Micropigmentación de Cejas',
    description: 'Curso brindado por MYBeautyStudy y dictado por Flavia Fernandes.',
    video: '/assets/videos webm,mp4/videosProjects/landingmicropigmentacion.mp4',
    repoLink: 'https://github.com/31pablo05/-micropicmentadoraInternacional-',
    liveLink: 'https://micropicmentadora-internacional.vercel.app/',
    tech: [
  ...
  return (
    ...
    >
      <div className="relative h-48 sm:h-56 md:h-64">
        <motion.img
          src="/assets/images webp/landingMicroPigmentadoraCaptura.webp"
          alt="Vista previa de Landing Page - Curso de Micropigmentación de Cejas"
        ...
        <motion.video
          src={project.video}
          poster="/assets/images webp/landingMicroPigmentadoraCaptura.webp"
          autoPlay
          loop
          muted
          aria-label="Video demo de Landing Page - Curso de Micropigmentación de Cejas"
          title="Video demo de Landing Page - Curso de Micropigmentación de Cejas"
      ...
      <div className="p-4">
        <h3
          className="text-xl font-bold mb-1 bg-gradient-to-r from-blue-400 via-purple-400 to-pink-400 bg-clip-text text-transparent drop-shadow-[0_2px_6px_rgba(0,0,0,0.8)]"
...
export default LandingMicropigmentacion;
