...
const WebAppMYBeautyStudy = () => {
  const [loaded, setLoaded] = useState(false);

  const project = {
    name: 'MYBeautyStudy - Estética de Cejas y Pestañas',
    video: '/assets/videos webm,mp4/videosProjects/MYBeautyStudy.mp4',
    repoLink: 'https://github.com/31pablo05/mybeautystudy',
    liveLink: 'https://mybeautystudy.vercel.app/',
    progress: 80,
    tech: [
      { icon: <FaHtml5 className="text-3xl text-orange-600" />, name: 'HTML5' },
      { icon: <SiTailwindcss className="text-3xl text-blue-600" />, name: 'TailwindCSS' },
  ...
  return (
    ...
    >
      <div className="relative h-48 sm:h-56 md:h-64">
        <motion.img
          src="/assets/images webp/CapturaMyBeautyStudy.webp"
          alt="Vista previa de MYBeautyStudy"
        ...
        <motion.video
          src={project.video}
          poster="/assets/images webp/CapturaMyBeautyStudy.webp"
          autoPlay
          loop
          muted
          aria-label="Video demo de MYBeautyStudy"
          title="Video demo de MYBeautyStudy"
...
export default WebAppMYBeautyStudy;
