...
const WebAppMYBeautyStudy = () => {
  ...
  const project = {
    name: 'Web App MYBeautyStudy - Estética de Cejas y Pestañas',
  ...
  return (
    <div className="card relative bg-white rounded-lg shadow-lg overflow-hidden">
      <div className="relative h-64">
        {!loaded && (
          <img
            src="/assets/imagesProjects/mybeautystudy-captura.webp"
            alt="Cargando..."
        ...
        <video
          src={project.video}
          poster="/assets/imagesProjects/mybeautystudy-captura.webp"
          autoPlay
          loop
          muted
