  ...
  return (
    ...
    >
      <div className="relative h-48 sm:h-56 md:h-64">
        <motion.img
          src="/assets/images webp/fedecaptura.webp"
          alt="Vista previa de Web App Federico Fotografía y Video"
        ...
        <motion.video
          src={project.video}
          poster="/assets/images webp/fedecaptura.webp"
          autoPlay
          loop
          muted
          aria-label="Video demo de Web App Federico Fotografía y Video"
          title="Video demo de Web App Federico Fotografía y Video"
