...
function Portfolio() {
  // Información de los proyectos (ahora con 8 proyectos)
  const projects = [
    {
      name: 'Tienda Online',
      image: 'path/to/store-image.png', // Reemplazar con la ruta correcta de la imagen del proyecto
    ...
    {
      name: 'Landing Page',
      image: 'path/to/landing-page-image.png', // Reemplazar con la ruta correcta
    ...
    },
    {
      ...
      image: '../assets/nutricionista', // Reemplazar con la ruta correcta
  ...
  return (
    <section id="portfolio" className="h-screen flex flex-col justify-center items-center bg-gradient-to-r from-blue-500 via-purple-600 to-indigo-800 text-white px-6 py-12">
